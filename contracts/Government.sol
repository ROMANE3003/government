...
//contract CitizenERC20 deployed at 0x632C0BF3d02DB2aC88590260FeC755Dae0919B3b
//contract Government deployed at 0x3Ee5296Fe3c71802ee25d6a4dE5A5dBB1700aC6A
...
contract Government {
    ...
    //Other variables
    uint256 private _retirementAge = 67;
    uint256 private _majorityAge = 18;
    ...
    constructor(
        ...
        //address payable sovereign,
        uint256 _priceSet
    ) public {
        _token = CitizenERC20(_tokenAddress); //contract CitizenERC20 deployed at 0x325525BE92FCdD9061f953E6Cf5a720C5a265982
        _sovereign = _token.getOwner(); // sovereign;
        //price for 1 full CTZ (10^18 tokens) in wei : 10**16 or 0.01 ether or 10000000000000000
        _price = _priceSet;
        _denomination = 10**uint256(_token.decimals());
    }
    ...
    function proposal(uint256 _id) public view returns (Proposal memory) {
    ...
    function proposePolicy(string memory _policy, string memory _description) public onlyAdmin {
        ...
        _proposals[count] = Proposal(count, _policy, _description, 0, 0, 0);
    }

    /// @dev function to vote on policy proposals
    function votePolicy(uint256 _id, Option _voteOption) public onlyAdmin {
        require(_proposals[_id].didVote[msg.sender] == false, "admin already voted for this proposal");
        ...
        _proposals[_id].didVote[msg.sender] = true;
    }
    ...
    function punish(address _sentenced, Punishment _option) public onlyAdmin {
        ...
        uint256 currentBalance = _citizens[_sentenced].nbOfCurrentAccountTokens;
        ...
        _citizens[_sentenced].nbOfCurrentAccountTokens = currentBalance;
    }
